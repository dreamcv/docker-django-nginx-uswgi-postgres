// 注释1: 最外层Function, 传入一个窗体对象; 将 Jtopo 变化为一个可以编辑的对象
!function (window) {
    // 注释1.1: 元类方法，元素构造函数
    function Element() {
    ...
    // 注释14: 从 a Array 中遍历元素b, 找到第一次出现的角标, 移除
   function removeFromArray(a, b) {
    ...
    // 注释16: JTopo.Stage(canvas)的canvas对象中传入 Json
