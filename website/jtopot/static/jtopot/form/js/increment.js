$(function() {
    ...
    $("#page-wrap div").append('<img src="/static/jtopot/form/images/mousewheelupdown.png" alt="Scroll up or down with mousewheel" />');
...
$(function() {
    ...
    $("#cate").bind("mousewheel", function(event, delta) {
        if (this.value == "交通") {
            this.value = "治安";
        }
        else if (this.value == "户政") {
            this.value = "网安";
        }
        else if (this.value == "网安") {
            this.value = "治安";
        }
        else if (this.value == "治安") {
            this.value = "交通";
        }
        return false;
     });
